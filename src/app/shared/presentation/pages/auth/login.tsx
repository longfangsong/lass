...
import { ConsentDialog } from "../../components/ConsentBanner";
import { usePrivacyConsent } from "../../hooks/usePrivacyConsent";

export default function Login() {
  const { hasConsented, isLoaded, giveConsent } = usePrivacyConsent();
  ...
  const handleConsentAccept = () => {
    ...
    if (pendingProvider) {
      window.location.href = `/api/auth/login/${pendingProvider}`;
    }
  };
