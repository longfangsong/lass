...
import type { Progress, Tasks } from "@/app/dictionary/presentation/atoms/init";
import { DB, db } from "@/app/shared/infrastructure/indexeddb";
import { inited } from "@/app/dictionary/domain/service";
